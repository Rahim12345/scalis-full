...
@section('title') {{ __('menus.products') }} - {{ $main_menu->{'name_'.app()->getLocale()} }} - {{ $sub_menu_1->{'sub_menuname__1'.app()->getLocale()} }} - {{ $sub_menu_2->{'name_'.app()->getLocale()} }} @endsection
@section('css')
                        ...
                        <div class="products_section_category cat-two" >
                            <nav>
                                <div class="nav nav-tabs fade show active" id="nav-tab-two" role="tablist">
                                    ...
                                    @if(request()->segment(4) == $sub_two_menu->{'slug_'.app()->getLocale()})
                        ...
                        <div class="products_section_body"  id="nav-tabContent">
                            <div class="products-section_body_fra fade show active" id="nav-aa" role="tabpanel" aria-labelledby="nav-aa-tab">
                                <div class="col-lg-12 products_section_body_gallery">
                                    {{-- @dd($sub_menu_2) --}}
                                    @foreach ($sub_menu_2->getProducts as $product)
                                    <a href="{{ route('front.products.main_menu.sub_menu_1.sub_menu_2.product_slug',['main_menu'=>$sub_two_menu->subMenuOne->mainMenus->{'slug_'.app()->getLocale()},'sub_menu_1'=>$sub_two_menu->subMenuOne->{'slug_'.app()->getLocale()},'sub_menu_2'=>$sub_menu_2->{'slug_'.app()->getLocale()},'product_slug'=>$product->slug_az]) }}">
                                        <div class="imag ">
