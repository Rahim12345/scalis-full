                        ...
                        <div class="content p-3">
                            <form action="{{ route('about.store') }}" id="about-form" method="POST" enctype="multipart/form-data" onsubmit="return false">
                                ...
                                <div class="form-group mb-3">
                                    1780x665
                                    <span class="avatar avatar-xl mb-3 image-change cursor-pointer" id="image-change" style="display: block !important;width: 100% !important;height: 300px;background-image: url({{ asset('files/about/'.$about->banner_image) }});"><img id="change-image" src="{{ asset('back/images/add-image.png') }}" alt="Şəkili dəyiş" style="position: absolute;float: right;bottom: 0;right: 0;width: 30px;cursor: pointer"></span>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="about_us_az" id="about_us_az" class="form-control w-100 @error('about_us_az') is-invalid  @enderror" rows="10" placeholder="{{ __('static.about_us_az') }} ...">{{ $about->about_us_az }}</textarea>
                                    <small class="text-danger" id="about_us_az-error"></small>
                                </div>

                                <div class="form-group mb-3">
                                    <label class="form-label" for="about_us_en">{{ __('static.about_us_en') }}</label>
                                    <textarea name="about_us_en" id="about_us_en" class="form-control w-100 @error('about_us_en') is-invalid  @enderror" rows="10" placeholder="{{ __('static.about_us_en') }} ...">{{ $about->about_us_en }}</textarea>
                                    <small class="text-danger" id="about_us_en-error"></small>
                                </div>

                                <div class="form-group mb-3">
                                    <label class="form-label" for="about_us_ru">{{ __('static.about_us_ru') }}</label>
                                    <textarea name="about_us_ru" id="about_us_ru" class="form-control w-100 @error('about_us_ru') is-invalid  @enderror" rows="10" placeholder="{{ __('static.about_us_ru') }} ...">{{ $about->about_us_ru }}</textarea>
                                    <small class="text-danger" id="about_us_ru-error"></small>
                                </div>

                                <div class="form-group">
                                    <button class="btn btn-primary float-end" type="button" id="add">{{ __('static.redakte') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
