    ...
    <div class="page">
        ...
        <div class="content">
            <div class="mb-3 col-md-8 offset-md-2 table-responsive" style="overflow-x: hidden;padding: 0 10px !important;">
                <a href="{{ route('back-blog.create') }}" class="btn btn-primary w-100">{{ __('static.elave_et') }}</a>
        ...
        function getUsers(table) {
            table.DataTable({
                ...
                createdRow: function( row, data, dataIndex ) {
                    $( row ).find('td:eq(0)').attr('data-label', "Şəkil");
                    $( row ).find('td:eq(1)').attr('data-label', "Başlıq");
                    $( row ).find('td:eq(2)').attr('data-label', 'Oxunub');
